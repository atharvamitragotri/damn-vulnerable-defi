...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {
        ...
        const ClimberAttack = await ethers.getContractFactory('ClimberAttack', attacker);
        this.attack = await ClimberAttack.deploy(this.vault.address, this.timelock.address);
